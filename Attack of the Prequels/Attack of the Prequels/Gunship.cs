...
namespace Attack_of_the_Prequels
{
    class Gunship : EnemyShip
    {
        ...
        public Gunship(ContentManager Content, Player p, Random rand)
            : base(Content, p)
        {

            this.p = p;

            velocity = p.initialVelocity - p.initialVelocity / 1.5f;
            ...
            scale = 272f;
            //scale = 1500f;
            model = Content.Load < Model > ("gunship2");
